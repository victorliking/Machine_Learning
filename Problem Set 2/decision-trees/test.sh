...
#java -cp lib/weka.jar:bin cs446.homework2.SGDtest ./../badges.example.arff
#java -cp lib/weka.jar:bin cs446.homework2.TREEtest ./../badges.example.arff
java -cp lib/weka.jar:bin cs446.homework2.StumpsTest ./../badges.example.arff